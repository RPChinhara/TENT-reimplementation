...
class CifarResNet(nn.Module):
    """CIFAR ResNet with depth 6n + 2. ResNet-26 corresponds to n = 4."""

    def __init__(self, block, layers, num_classes=10, width=1):
        super().__init__()
...
def resnet26(num_classes=10, width=1):
    return CifarResNet(BasicBlock, [4, 4, 4], num_classes=num_classes, width=width)
